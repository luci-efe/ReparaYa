# Spec Delta: Weekly Availability Rules
...
- [ ] TC-RF-CTR-AVAIL-001: Create weekly rule successfully (integration test)
- [ ] TC-RF-CTR-AVAIL-002: Reject overlapping intervals (unit test)
- [ ] TC-RF-CTR-AVAIL-003: List weekly rules by contractor (integration test)
- [ ] TC-RF-CTR-AVAIL-016: Contractor authorization enforced (integration test)
- [ ] TC-RF-CTR-AVAIL-018: Admin read-only access works (integration test)
...
**Errors**:
- 400: Validation failed (overlapping intervals, invalid dayOfWeek, malformed times)
- 401: Not authenticated
- 403: Not authorized (not the contractor owner)
