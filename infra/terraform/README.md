...
- **S3**: ~-2/mes (almacenamiento + requests)
- **SES**: /usr/bin/bash.10 por 1,000 emails (sandbox gratis hasta límite)
- **Location Service**: ~/usr/bin/bash.50-1/mes para geocodificación básica
- **Total estimado**: </mes
