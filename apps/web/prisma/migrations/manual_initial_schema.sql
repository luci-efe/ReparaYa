...
CREATE TYPE "BookingStatus" AS ENUM ('PENDING_PAYMENT', 'CONFIRMED', 'ON_ROUTE', 'ON_SITE', 'IN_PROGRESS', 'COMPLETED', 'NO_SHOW', 'CANCELLED', 'DISPUTED');
CREATE TYPE "PaymentType" AS ENUM ('ANTICIPO', 'LIQUIDACION', 'REEMBOLSO');
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'SUCCEEDED', 'FAILED', 'REFUNDED');
CREATE TYPE "ModerationStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
CREATE TYPE "DisputeStatus" AS ENUM ('OPEN', 'RESOLVED_UPHOLD_CLIENT', 'RESOLVED_UPHOLD_CONTRACTOR', 'RESOLVED_PARTIAL');
