...
CREATE TABLE public.enum BookingStatus {
  PENDING_APPROVAL
  PENDING_PAYMENT
  CONFIRMED
  ON_ROUTE
...
CREATE TABLE public.Service (
  ...
  visibilityStatus USER-DEFINED NOT NULL DEFAULT 'DRAFT'::"ServiceVisibilityStatus",
...
CREATE TABLE public.ServiceCategory (
  ...
  CONSTRAINT ServiceCategory_parentId_fkey FOREIGN KEY (parentId) REFERENCES public.ServiceCategory(id)
);
...
CREATE TABLE public.contractor_availability_blocks (
  ...
  CONSTRAINT contractor_availability_blocks_contractorProfileId_fkey FOREIGN KEY (contractorProfileId) REFERENCES public.ContractorProfile(id)
);
CREATE TABLE public.contractor_availability_exceptions (
  ...
  CONSTRAINT contractor_availability_exceptions_contractorProfileId_fkey FOREIGN KEY (contractorProfileId) REFERENCES public.ContractorProfile(id)
);
CREATE TABLE public.contractor_weekly_rules (
  ...
  CONSTRAINT contractor_weekly_rules_contractorProfileId_fkey FOREIGN KEY (contractorProfileId) REFERENCES public.ContractorProfile(id)
);
